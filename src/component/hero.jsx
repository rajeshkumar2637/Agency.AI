...
const hero = () => {
  return (
    ...
    text-gray-700 dark:text-white'>
        ...
        xl:leading-[95px] max-w-5xl ' >Turing imagination into <span className='bg-gradient-to-r from-[#0323f5ea] bg-clip-text
      ...
      75 max-w-4/5 sm:max-w-lg pb-3' >Creating meaningful connections and turning big ideas into
